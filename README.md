...
It isn't necessary to setup MCP to play with this project, but it was created in collaboration with Claude. This project is 
largely as generated by Claude. The only exception is the Blueprint code. I haven't changed any of the functionality, but I
did re-arrange the graph significantly to make it readable. The Claude generated graph was laughable, but fully functional.

## Purpose

The point of this project is experimentation: to see how an AI assistant (via MCP)
can drive Unreal Editor — spawning and arranging actors, creating materials,
manipulating a level, and adding animation with Blueprint — rather than to build a finished game or application.
